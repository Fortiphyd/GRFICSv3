...
typedef struct {
  ...
  __DECLARE_LOCATED(BOOL,MANUAL_MODE)
  __DECLARE_LOCATED(UINT,F1_MANUAL_SP)
  __DECLARE_LOCATED(UINT,F2_MANUAL_SP)
  __DECLARE_LOCATED(UINT,PURGE_MANUAL_SP)
  __DECLARE_LOCATED(UINT,PRODUCT_MANUAL_SP)
